...
RELEASE_LFLAGS = -DRELEASE # flags for release: optimised build, no verbosity...
RELEASE_RFLAGS = # flags for release: optimised build, no verbosity...
# compiler flags for testing:
TEST_LFLAGS = -DTEST # flags for release: optimised build, no verbosity...
TEST_RFLAGS = # flags for release: optimised build, no verbosity...
# compiler flags for benchmark:
BENCHMARK_LFLAGS = -DBENCHMARK # flags for release: optimised build, no verbosity...
